...
3. States: every applicable state present and telling what happened, what to do, and what was kept (the state list in #27). [finding]
...
|---|---|---|---|
| [empty] | [light] | [desk] | [path or link] |
| [loading] | [dark] | [phone] | [path or link] |

## Done

- [ ] The eight checks pass with evidence.
