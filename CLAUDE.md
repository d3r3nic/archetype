...
- The owner picks the visual direction from proposed directions and decides what each primary screen is for; within the picked direction the session decides composition, states, and words, records them in the artifact, and shows them. Never ask the owner a designer's question; never improvise a screen outside the system. → conventions/27-design-foundation.md, conventions/29-decision-authority.md
