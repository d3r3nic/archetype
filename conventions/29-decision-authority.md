...
- A change to what the product is includes its visual identity. The AI never picks the look alone: it proposes two to four directions with one recommended, the owner picks, the pick is recorded (#27). Fidelity and interactivity of a design deliverable follow the stated purpose and are not owner questions unless the purpose leaves them open.
...
- Choose the product's look without you picking it from the directions I propose.
...
- Under either setting, the AI choosing the product's visual identity instead of proposing directions for the owner's pick
